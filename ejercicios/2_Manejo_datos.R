...
write.table(bond, "ejercicios/data/007_edited.csv")
write.csv(bond, "ejercicios/data/007_edited.csv") #idem depende de los parametros
save(bond, file = "ejercicios/data/bond.R") #Rdata
...
table(bond$Director, bond$Actor_p)
